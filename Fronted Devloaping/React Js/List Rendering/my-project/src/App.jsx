...
export const Task_1 = () => {
  ...
  return (
    <div>
           <div>
              <h1 class="text-5xl font-bold text-center text-amber-900">React js Search Bar</h1>
              ...
              <div >
                <ul class="flex flex-wrap justify-around text-center">
                  ...
                  products.filter((item) => {
                      return Search.toLowerCase() == '' ? item : item.category.includes(Search)
                  }).map((item) => {
                        return(
                        <>
                            <div className='border border-5 p-5 border-black mt-5'>
                              <img src={item.images} class="h-44 w-48" />
                               <p>{item.title}</p>
                               <p>{item.price}</p>
                            </div>   
                        </>
